...
public class SSRealTimeSelfieCaptureCameraView
{
    ...
    private class GraphicFaceTracker extends Tracker<Face>
    {
        ...
        {
            mOverlay = overlay;
            mSSRealTimeSelfieCaptureView = new SSRealTimeSelfieCaptureView(overlay);

            mSSRealTimeSelfieCaptureView.setFaceGraphicDelegate(new SSRealTimeSelfieCaptureView.FaceGraphicDelegate()
            {
                @Override
...
//                                Toast.makeText(context,"Captured !",Toast.LENGTH_SHORT).show();
        ...
        {
            mSSRealTimeSelfieCaptureView.setId(faceId);
        }
        ...
        {
            mOverlay.add(mSSRealTimeSelfieCaptureView);
            mSSRealTimeSelfieCaptureView.updateFace(face);
        }
        ...
        {
            mOverlay.remove(mSSRealTimeSelfieCaptureView);
        }
